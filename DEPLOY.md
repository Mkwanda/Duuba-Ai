...
- Link your GitHub repo and choose the repo/branch and `COCOA Train model new.py` as the main file.
...
3) Docker
- Build: `docker build -t cocoa-detector .`
- Run: `docker run -p 8501:8501 cocoa-detector`
